		...
		<c:forEach var="item" items="${goodsMap.bestseller}">
			<div class="goods-item">
				<a
					...
					<img
					src="${contextPath}/uploads/${item.goods_id}/${item.goods_fileName}"
					onerror="this.onerror=null; this.src='${contextPath}/resources/image/no-image.png';"
					alt="상품 이미지" / loading="lazy" decoding="async">
					...
					<p class="goods-price">
						<fmt:formatNumber value="${item.goods_sales_price}" type="number" />
						원
					</p>
				</a>
			</div>
