...
public class AdminGoodsServiceImpl implements AdminGoodsService {
    ...
    @Override
    public List<GoodsVO> searchGoods(Map<String, Object> searchMap) throws Exception {
        return adminGoodsDAO.searchGoods(searchMap);
    }

    @Override
    public void changeGoodsStatus(Map<String, Object> statusMap) throws Exception {
        adminGoodsDAO.updateGoodsStatus(statusMap);
    }
}
